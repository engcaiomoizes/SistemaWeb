...
export default function TiposForm(props: any) {
    ...
    const handleLoad = async () => {
        try {
            ...
            const response = await fetch(`/api/tipos/${props.id}`);
    ...
    return (
        ...
        <div className="flex justify-center p-10">
            <div className="container">
                <button onClick={() => redirect('/tipos')} className="cursor-pointer flex items-center font-medium gap-2 ms-10"><FaChevronLeft /> Voltar</button>
