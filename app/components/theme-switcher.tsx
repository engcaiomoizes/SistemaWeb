...
export default function ThemeSwitcher() {
    ...
    return (
        <span className="text-white">
            {
                dark ?
                <svg className="w-6 h-6 text-white dark:text-white cursor-pointer" onClick={handleTheme} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
