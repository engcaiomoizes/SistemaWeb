...
export default function RamalList() {
    ...
    return (
        <div className="flex h-screen justify-center">
            <div className="container px-10 py-6">
                <div className="flex justify-end w-full mb-2 space-x-4">
                    ...
                    <div className="flex space-x-2">
                        <button onClick={() => setReportIsOpen(true)} className="cursor-pointer border px-2 rounded-lg border-blue-700 bg-blue-700 text-white hover:bg-blue-800 hover:border-blue-800 transition ease-in-out duration-100">
                            <GoAlertFill size={20} />
                        </button>
                    </div>
                    <Report isOpen={reportIsOpen} onClose={() => setReportIsOpen(false)} onSend={(msg) => setMessage(msg)} />
                </div>
            ...
            {
                message &&
                <div id="toast-success" className="absolute bottom-0 left-20 flex items-center w-full max-w-md p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                    ...
                    <button type="button" onClick={() => setMessage("")} className="cursor-pointer ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-success" aria-label="Close">
